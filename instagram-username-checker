...
func ghoul(u string) bool {
	...
	req, _ := http.NewRequest("GET", "https://instagram.com/"+u, nil)
...
func main() {
	...
	fmt.Printf("%s%s\n", black("https://github.com/rip/go-ghoul/"), blue("instagram-404-username-checker"))
	...
	for _, username := range usernames {
		...
		go func(username string) {
			...
			success = ghoul(username)
		}(username)
		if success == true { //////////doesntseemtoworklol
			// reset success flag, break loop, and move down the list
			success = false
			break
		}
	}
